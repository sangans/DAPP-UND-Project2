...
contract StarNotary is ERC721 {
    ...
    string public constant name = "A Star is Born";
    string public constant symbol = "ASB"; 
    ...
    // Passing the name, tokenId, tokenName and tokenSymbol as a parameters
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOfToken1 == msg.sender || ownerOfToken2 == msg.sender, "You can't transfer a star that you don't own");
